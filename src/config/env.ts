...
export const envSchema = z
  .object({
    ...
    CRON_SECRET: z.string().min(16, 'CRON_SECRET is required and must be at least 16 characters long'),
    WEBHOOK_AUTH_TOKEN: z.string().min(16, 'WEBHOOK_AUTH_TOKEN is required and must be at least 16 characters long'),
